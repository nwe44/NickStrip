...
(function($, wp, wps, window, undefined){
	...
	*/
	...
	methods = {
		...
		possible signatures. LetÍs look at each of them.
	...
	*/
	var jQMethods = {
		...
		This will force a recalculation of each waypointÍs trigger point based on
		its offset option. This is called automatically whenever the window is
		resized, new waypoints are added, or a waypointÍs options are modified.
	...
	*/
	...
	Settings object that determines some of the pluginÍs behavior.
	...
	resizeThrottle
		...
		refreshes. For more information on throttling, check out Ben AlmanÍs
	...
	scrollThrottle
		...
		AlmanÍs throttle / debounce plugin.
		http://benalman.com/projects/jquery-throttle-debounce-plugin/
	*/
	$[wps].settings = {
		resizeThrottle: 200,
